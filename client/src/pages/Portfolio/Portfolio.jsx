  ...
  return (
    <React.Fragment>
      <head>
        ...
        <meta name="description" content="Портфолио UwU Studio: примеры наших работ в веб-дизайне, графическом дизайне, брендинге и разработке логотипов. Узнайте больше о наших проектах в Крыму и Симферополе." />
